...
func (h *AgentsHandler) handleRegenerate(w http.ResponseWriter, r *http.Request) {
	...
	go h.summoner.RegenerateAgent(store.TenantIDFromContext(r.Context()), id, ag.Provider, ag.Model, req.Prompt)
...
func (h *AgentsHandler) handleResummon(w http.ResponseWriter, r *http.Request) {
	...
	go h.summoner.SummonAgent(store.TenantIDFromContext(r.Context()), id, ag.Provider, ag.Model, description)
